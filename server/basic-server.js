...
var requestListener = function (request, response) {
  ...
  var routes = {
    ...
    '/' : function(){ req.loadFile(response, '../client/client/index.html', 'text/html');},
    '/styles/styles.css' : function(){ req.loadFile(response, '../client/client/styles/styles.css', 'text/css');},
    ...
    '/scripts/config.js' : function(){ req.loadFile(response, '../client/client/scripts/config.js', 'text/javascript');},
    '/scripts/app.js' : function(){ req.loadFile(response, '../client/client/scripts/app.js', 'text/javascript');}
  };
